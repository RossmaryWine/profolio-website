...
export const experience: Experience[] = [
  {
    ...
    dateRange: "Jan 2026 to Apr 2026",
    description:
    ...
    accomplishments: [
      ...
      "Designed a custom fixed width ingestion algorithm that parsed records using configurable widths and column specifications, handled both byte based and character based encodings, validated malformed records, and staged normalized data for Parquet export.",
  ...
  },
  {
    ...
    dateRange: "Sept 2023 to Dec 2023",
    description:
  ...
  },
  {
    ...
    location: "Ottawa, Canada",
    dateRange: "Jan 2023 to May 2023",
    description:
